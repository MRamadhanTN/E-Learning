...
@section('content')
    <div class="main-content flex-1 bg-gray-200 md:pb-5 h-screen">
        <div class="bg-blue-500 ">
            ...
            "
            >
                <h3 class="font-medium pl-2">Class</h3>
                <div class="flex">
        ...
        <div class="flex flex-1 px-7 justify-between mt-7">
            ...
            <div class="flex">
                <a href="{{ route('classCreate') }}" class="shadow-lg flex-1 flex items-center justify-center rounded-xl px-3 py-2 space-x-2 bg-red-500 text-white font-semibold hover:text-yellow-200 transition delay-150 duration-500 transform hover:-translate-y-0 hover:scale-105">
