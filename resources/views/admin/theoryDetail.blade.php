...
@section('content')
    <div class="main-content flex-1 bg-gray-200 md:pb-5">
        <div class="bg-blue-500 ">
            ...
            "
            >
                <h3 class="font-medium pl-2" data-aos="fade-right" data-aos-duration="800" data-aos-delay="100"><a href="{{ route('dashboardTheory') }}">Theory</a> / <a href="{{ route('theoryDetail') }}">Detail</a></h3>
        ...
        <div class="mt-10 mb-5 flex justify-center items-center" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="700">
            <div class="bg-blue-500 shadow-lg px-12 py-8 rounded-2xl text-white">
                <h1 class="text-4xl font-bold mb-5 text-center">Review Theory</h1>
                <form action="#" method="post" class="flex flex-col items-start">
                    ...
                    <label class="text-lg font-bold">Class</label>
                ...
                <div class="flex justify-end mt-8">
                    <a href="{{ route('theoryEdit')}}" class="rounded-full text-lg font-bold px-8 py-1 text-center bg-yellow-500 hover:bg-yellow-400 transition duration-500 transform hover:-translate-y-0 hover:scale-110 tracking-wider shadow-lg">Edit</a>
                </div>
            </div>
        </div>
        </div>
