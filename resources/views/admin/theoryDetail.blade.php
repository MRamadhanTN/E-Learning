...
@section('content')
    <div class="main-content flex-1 bg-gray-200 md:pb-5">
        <div class="bg-blue-500 ">
            ...
            "
            >
                <h3 class="font-medium pl-2">Theory / Detail</h3>
                <div class="flex">
        ...
        <div class="mt-10 mb-5 flex justify-center items-center">
            <div class="bg-blue-500 px-12 py-8 rounded-2xl text-white">
                ...
                <div class="flex justify-end mt-8">
                    <a href="{{ route('theoryEdit')}}" class="rounded-full text-lg font-bold px-8 py-1 text-center bg-yellow-500 hover:bg-yellow-400 transition duration-300 tracking-wider">Edit</a>
                </div>
            </div>
        </div>
        </div>
