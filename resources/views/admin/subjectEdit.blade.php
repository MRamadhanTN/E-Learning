...
@section('content')
    <div class="main-content flex-1 bg-gray-200 md:pb-5">
        <div class="bg-blue-500 ">
            ...
            "
            >
                <h3 class="font-medium pl-2" data-aos="fade-right" data-aos-duration="800" data-aos-delay="100"><a href="{{ route('dashboardSubject') }}">Subject</a> / <a href="{{ route('subjectEdit') }}">Edit</a></h3>
        ...
        <div class="mt-10 mb-5 flex justify-center items-center" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="700">
            <div class="bg-blue-500 shadow-lg px-10 py-6 rounded-2xl text-white text-center">
                <h1 class="text-4xl font-bold mb-3">Edit Subject</h1>
                <form action="#" method="post" class="flex flex-col items-start">
                    <label class="text-lg font-medium">Name</label>
                    <input type="text" class="shadow-lg text-blue-900 focus:outline-none rounded-xl w-96 bg-gray-100 px-4 py-2 mb-3" placeholder="enter name subject" value="PHP">
                    ...
                    <textarea name="" id="" cols="34" rows="5" class="focus:outline-none bg-gray-100 rounded-xl px-4 py-2 text-blue-900 shadow-lg">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, dummy text ever since the 1500s, dummy text ever since the 1500s, dummy text ever since the 1500s, dummy text ever since the 1500s, dummy text ever since the 1500s, </textarea>
                </form>
