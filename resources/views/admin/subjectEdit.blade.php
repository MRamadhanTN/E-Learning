...
@section('content')
    <div class="main-content flex-1 bg-gray-200 md:pb-5">
        <div class="bg-blue-500 ">
            ...
            "
            >
                <h3 class="font-medium pl-2">Subject / Edit</h3>
                <div class="flex">
        ...
        <div class="mt-10 mb-5 flex justify-center items-center">
            <div class="bg-blue-500 px-10 py-6 rounded-2xl text-white text-center">
                ...
                <form action="#" method="post" class="flex flex-col items-start">
                    ...
                    <textarea name="" id="" cols="34" rows="5" class="focus:outline-none bg-gray-100 rounded-xl px-4 py-2 text-blue-900">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, dummy text ever since the 1500s, dummy text ever since the 1500s, dummy text ever since the 1500s, dummy text ever since the 1500s, dummy text ever since the 1500s, </textarea>
                </form>
