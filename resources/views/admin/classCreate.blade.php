...
@section('content')
    <div class="main-content flex-1 bg-gray-200 md:pb-5">
        <div class="bg-blue-500 ">
            ...
            "
            >
                <h3 class="font-medium pl-2" data-aos="fade-right" data-aos-duration="800" data-aos-delay="100"><a href="{{ route('dashboardClass') }}">Class</a> / <a href="{{ route('classCreate') }}">Create</a></h3>
                <div class="flex z-10" data-aos="zoom-in" data-aos-delay="200" data-aos-duration="800">
                        ...
                        <div x-data="{ dropdownOpen: false }" class="relative px-3" data-aos="zoom-in" data-aos-delay="300" data-aos-duration="800">
                            ...
                            <div x-show="dropdownOpen" class="absolute right-0 mt-2 w-28 bg-white rounded-md shadow-xl z-20 text-center font-medium">
                                <a href="{{ route('Admin') }}" class="{{ (request()->is('MyProfile')) ? 'hidden':'block' }} px-4 py-2 text-sm capitalize text-gray-700 hover:bg-blue-500 hover:text-white">
                                    My Profile
                                </a>
                                <a href="{{ route('AdminEdit') }}" class="{{ (request()->is('EditProfileStudent')) ? 'hidden':'block' }} px-4 py-2 text-sm capitalize text-gray-700 hover:bg-blue-500 hover:text-white">
                                    Settings
                                </a>
        ...
        <div class="mt-10 mb-5 flex justify-center items-center" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="700">
            <div class="bg-blue-500 shadow-lg px-10 py-6 rounded-2xl text-white text-center">
                <h1 class="text-4xl font-bold mb-3">Create Your Class</h1>
                <form action="#" method="post" class="flex flex-col items-start">
                    ...
                    <textarea name="" id="" cols="34" rows="5" class="focus:outline-none bg-gray-100 rounded-xl px-4 py-2 text-blue-900 shadow-lg"></textarea>
                </form>
                <div class="flex justify-end mt-5">
                    <button type="submit" class="rounded-full text-lg font-bold px-5 py-1 text-center bg-yellow-500 hover:bg-yellow-400 transition duration-300 shadow-lg delay-150 transform hover:-translate-y-0 hover:scale-110 tracking-wider">Create</button>
                </div>
            </div>
        </div>
        </div>
