            ...
            <div class="px-7 mt-10">
                <table class="table-auto text-left bg-blue-500 rounded-xl w-full display text-blue-900 shadow-xl" id="table_id" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="100">
                    ...
                    <tbody class="bg-blue-200">
                        <tr class="grid grid-cols-11 py-5 font-semibold items-start" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="700">
                            <td class="col-span-1 text-center">1</td>
                            <td class="col-span-5 overflow-y-auto overflow-x-hidden h-14 example">
                        ...
                        <tr class="grid grid-cols-11 py-5 font-semibold items-start" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="800">
                        ...
                        <tr class="grid grid-cols-11 py-5 font-semibold items-start" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="900">
                        ...
                        <tr class="grid grid-cols-11 py-5 font-semibold items-start" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="1000">
