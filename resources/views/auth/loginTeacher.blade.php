...
@section('content')
        <div class="absolute left-1/3 ml-16 top-32" data-aos="fade-up" data-aos-duration="500" >
                <div class="text-blue-900">
                    <div class="border rounded-xl shadow-xl mx-auto block md:inline-block" data-aos="fade-up" data-aos-duration="700" width="200">
                        <img class="rounded-t-xl ml-40 mt-10" src="{{ asset('image/teacher.png') }}" alt="image" width="150">
                        <div class="text-2xl font-bold text-center mt-10 mx-20">WELCOME TO SMARTSCHOOL</div>
                        <div class="text-xs uppercase text-center mb-10 leading-relaxed tracking-wider mt-1">A teacher is someone who <br> dares to teach by not stopping learning</div>
                        <div class="">
