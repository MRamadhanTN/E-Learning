...
@section('content')
        <div class="absolute left-1/3 top-32" data-aos="fade-up" data-aos-duration="500">
                <div class="text-blue-900">
                    <div class="border rounded-xl shadow-xl mx-auto block md:inline-block py-16" data-aos="fade-up" data-aos-duration="700">
                        <div class="text-4xl font-bold text-center mb-4">Teacher Registration</div>
                        ...
                        <div class="">
                            <form action="#" method="post" class="flex flex-col gap-y-2 items-center ">
                                ...
                                <input type="password" class="border text-center shadow-sm rounded-xl w-96 bg-gray-50 px-4 py-2 mb-5" placeholder="repeat your password">

                                <label class="text-lg font-medium">Skill</label>
                                <select name="skill" id="skill" class="border shadow-sm rounded-xl w-96 bg-gray-50 px-4 py-3 text-">
